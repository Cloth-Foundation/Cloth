...
> It is recommended to use [JetBrains Rider](https://www.jetbrains.com/rider/)
> or [Visual Studio](https://visualstudio.microsoft.com/) as Cloth is a .NET project, currently written in C# and F#.
...
* Language server (LSP) support for [VSCode](https://github.com/Cloth-Foundation/Cloth-VSCode-Language-Support)
  or [JetBrains](https://github.com/Cloth-Foundation/Cloth-Jetbrains-Language-Support).
